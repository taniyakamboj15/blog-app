        ...
        <div className="flex justify-center items-center min-h-[80vh] animate-in fade-in zoom-in-95 duration-500">
            <div className="w-full max-w-md bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-8 border border-gray-100 dark:border-gray-800">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-2">{t('welcome_back')}</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    >
                        ...
                        {loading ? t('auth_signing_in') : t('login')}
                    </button>
                </form>

                <p className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
                    {t('no_account')}{' '}
                    <Link to="/signup" className="font-semibold text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 hover:underline">
                        {t('signup')}
                    </Link>
                </p>
            </div>
